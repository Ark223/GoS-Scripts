...
function Cassiopeia:__init()
	...
	self.CassiopeiaMenu.Combo:MenuElement({id = "MinW", name = "W: Minimum Enemies", value = 2, min = 1, max = 5, step = 1})
	...
	self.CassiopeiaMenu.Harass:MenuElement({id = "UseW", name = "W [Miasma]", value = false, leftIcon = Icons.."CassiopeiaW"..Png})
